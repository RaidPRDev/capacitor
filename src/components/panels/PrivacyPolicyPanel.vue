    ...
    <div class="pxlr-0 height-100">
      ...
      <div class="content-scroller relative">
        <div class="inner-scroller pxb-60 pxlr-16" ref="divScrollerRef" tabindex="0" @scroll="handleScroll">
          ...
          <p>If you have any questions about ELSO’s Privacy Policy, please contact us at: <a class="a-link" href="mailto:support@elso.org?subject=Bedside Guide App&body=Add your message">support@elso.org</a>.</p>
